 ...
 * 就可以在控制器方法中使用HttpServletRequest对象获取请求参数
 *
 * 2、通过控制器方法的形参获取
 ...
 * required:设置是否必须传输value属性所对应的请求参数
 * 默认值为true，表示value属性所对应的请求参数必须传输，否则页面报错：
 * 400 - Required String parameter 'xxx' is not present
 * 若设置为false，则表示value所对应的请求参数不是必须传输，若没有传输，则形参值为null
...
public class TestParamController {
    ...
    public String testGetParamByServletAPI(HttpServletRequest request){
